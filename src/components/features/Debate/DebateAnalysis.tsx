      ...
      <div className="bg-gray-900 rounded-xl border border-gray-700 w-full max-w-7xl h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Análisis del Debate</h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium text-sm"
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-medium text-sm"
            ...
            <button
              onClick={generateAnalysis}
              className="flex items-center gap-2 px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white rounded-lg font-medium"
            >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-2xl">{getTypeIcon(participant?.type || 'concept')}</span>
                      <div>
                        <h4 className="font-semibold">{argument.participantName}</h4>
                    ...
                    <div className="mb-3">
                      <h5 className="font-medium text-sm mb-1">Tesis Principal:</h5>
                      <p className="text-sm opacity-90">{argument.thesis}</p>
                    </div>
                    
                    {argument.arguments.length > 0 && (
                      <div className="mb-3">
                        <h5 className="font-medium text-sm mb-1">Argumentos:</h5>
                    ...
                    {argument.refutations.length > 0 && (
                      <div>
                        <h5 className="font-medium text-sm mb-1">Refutaciones:</h5>
                        <ul className="text-sm opacity-90 space-y-1">
