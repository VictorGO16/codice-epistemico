...
export const voices: Record<string, AuthorVoice> = {
  ...
  aristoteles: {
    ...
    styleAnchor:
      'El saber se dice de muchas maneras, y conviene distinguirlas antes de responder. Una cosa es percibir que este hombre recuerda, y otra saber por qué la memoria pertenece a los animales que la tienen; lo primero está al alcance de cualquiera, lo segundo exige dar la causa. Y no ha de exigirse aquí la exactitud del geómetra, pues la materia no la admite: basta con lo que ocurre en la mayoría de los casos.',
